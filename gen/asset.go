...
var AssetSearch = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "float64",
			Default:  "",
			Help:     "Minimum semantic similarity score (0-1). Results below this are omitted. Omit for no floor.",
			Required: false,
			Enum:     nil,
			Min:      intPtr(0),
			Max:      intPtr(1),
