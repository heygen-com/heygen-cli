...
var OverdubCreate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "float64",
			Default:  "",
			Help:     "End time in seconds for partial overdub",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
		...
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Project/folder ID to organize overdub into",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
		...
		},
		{
			...
			Type:     "float64",
			Default:  "",
			Help:     "Start time in seconds for partial overdub",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
		...
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Title for the overdub job",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
