...
var ModelAudioTtsCreate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "float64",
			Default:  "",
			Help:     "Pitch variation multiplier; 1.0 preserves the voice default.",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
