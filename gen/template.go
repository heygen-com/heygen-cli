...
var TemplateCreate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Template name. Defaults to the source video's title.",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
		...
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "ID of a video in your workspace to turn into a template. The video must have been generated with POST /v3/videos or saved in the HeyGen editor; its draft becomes the template's starting point.",
			Required: true,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
...
var TemplateDelete = &command.Spec{
	Group:          "template",
	Name:           "delete",
	Summary:        "Delete Template",
	Description:    "Soft-deletes a template. It disappears from the list and can no longer be used to generate videos; videos already generated from it are unaffected. Templates managed by another HeyGen product cannot be deleted here.",
...
var TemplateGenerate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Brand glossary controlling how custom terms are pronounced in generated speech. Discover IDs via GET /v3/brand-glossaries.",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
		...
		},
		{
			...
			Type:       "string",
			Default:    "",
			Help:       "Legacy field name for `brand_glossary_id`. Both are accepted and resolve to the same workspace record. Prefer `brand_glossary_id`.",
			Required:   false,
			Enum:       nil,
			Min:        nil,
			Max:        nil,
...
var TemplateUpdate = &command.Spec{
	Group:          "template",
	Name:           "update",
	Summary:        "Update Template",
	Description:    "Renames a template. Other properties are edited in the HeyGen editor or through PUT /v3/templates/{template_id}/variables. Returns the template detail.",
...
var TemplateVariablesUpdate = &command.Spec{
	Group:          "template",
