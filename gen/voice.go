...
var VoiceSpeech = &command.Spec{
	...
	BodyEncoding: "json",
	Examples: []string{
		"heygen voice speech 'Hello world' --voice-id en_male",
	},
	Args: []command.ArgSpec{
		{Name: "text", Target: "body", Param: "text", Help: "Text to synthesize (1-5000 characters)."},
	},
	Flags: []command.FlagSpec{
		{
			Name:     "input-type",
