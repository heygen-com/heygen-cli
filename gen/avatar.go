...
var AvatarConsentCreate = &command.Spec{
	...
	Description:    "Initiate a consent flow for an avatar group. Returns a consent URL that the user must visit in a browser to complete the consent process. Present this URL to the user. Optionally provide a reroute_url to redirect to after consent is completed.",
