...
var AvatarLookTemplatesList = &command.Spec{
	Group:          "avatar",
	Name:           "look-templates list",
	...
	Endpoint:       "/v3/avatars/look-templates",
	Method:         "GET",
	BodyEncoding:   "",
	Paginated:      true,
	Examples: []string{
	...
	Flags: []command.FlagSpec{
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Filter by generation method: 'look_pack' for Look Packs, 'template' for single look templates. Omit for both.",
			Required: false,
			Enum:     []string{"look_pack", "template"},
			Min:      nil,
			Max:      nil,
			Source:   "query",
			JSONName: "type",
		},
		{
			...
			Type:     "string",
			Default:  "",
			Help:     "Filter to templates built for 'male' or 'female'. Templates with no gender of their own are returned for either value. Omit for all.",
			Required: false,
...
var AvatarLooksCreate = &command.Spec{
	Group:          "avatar",
	Name:           "looks create",
...
var AvatarUpdate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		{
			Name:     "default-voice-id",
			Type:     "string",
			Default:  "",
			Help:     "Voice ID to set as the avatar's default voice, replacing the current one. The voice is also linked to the avatar group if it was not already. Accepts any voice available to your workspace, including imported voice clones. Only supported for avatars you own.",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
			Source:   "body",
			JSONName: "default_voice_id",
		},
	},
}
