...
var LipsyncCreate = &command.Spec{
	...
	Description:    "Dub or replace audio on a video using a provided audio file. Runs asynchronously — poll status via GET /v3/lipsyncs/{id}.",
...
var LipsyncDelete = &command.Spec{
	...
	Description:    "Permanently delete a lipsync.",
...
var LipsyncGet = &command.Spec{
	Group:          "lipsync",
	Name:           "get",
	Summary:        "Get lipsync details",
	Description:    "Get detailed information about a lipsync including status, URLs, and metadata.",
...
var LipsyncList = &command.Spec{
	...
	Description:    "List lipsyncs with cursor-based pagination.",
...
var LipsyncUpdate = &command.Spec{
	...
	Description:    "Update a lipsync's title.",
