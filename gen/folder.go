...
var FolderGet = &command.Spec{
	...
	Name:           "get",
	Summary:        "Get Folder",
	Description:    "Returns one folder in the caller's workspace, including one that is in the trash (is_trash is true). Use it to confirm a stored folder_id still exists before placing content in it. A folder that was deleted, or that belongs to another workspace, is reported as not found. API keys need the videos:read scope.",
	ResponseSchema: "{\n  \"properties\": {\n    \"data\": {\n      \"description\": \"A folder in the caller's workspace.\",\n      \"properties\": {\n        \"created_at\": {\n          \"description\": \"Unix timestamp (seconds) when the folder was created.\",\n          \"type\": \"integer\"\n        },\n        \"creator_username\": {\n          \"description\": \"Username of the workspace member who created the folder.\",\n          \"nullable\": true,\n          \"type\": \"string\"\n        },\n        \"folder_id\": {\n          \"description\": \"Unique folder identifier. Pass as folder_id to POST /v3/videos or POST /v3/video-translations, or as parent_id to POST /v3/folders.\",\n          \"type\": \"string\"\n        },\n        \"is_trash\": {\n          \"description\": \"Whether the folder is in the trash.\",\n          \"type\": \"boolean\"\n        },\n        \"name\": {\n          \"description\": \"Folder name.\",\n          \"type\": \"string\"\n        },\n        \"parent_id\": {\n          \"description\": \"ID of the containing folder. Absent for a folder at the workspace root.\",\n          \"nullable\": true,\n          \"type\": \"string\"\n        },\n        \"type\": {\n          \"description\": \"Kind of folder; see the type field of POST /v3/folders.\",\n          \"enum\": [\n            \"mixed\",\n            \"video\",\n            \"video_translate\"\n          ],\n          \"type\": \"string\"\n        },\n        \"updated_at\": {\n          \"description\": \"Unix timestamp (seconds) when the folder was last updated.\",\n          \"type\": \"integer\"\n        }\n      },\n      \"required\": [\n        \"folder_id\",\n        \"name\",\n        \"type\",\n        \"is_trash\",\n        \"created_at\",\n        \"updated_at\"\n      ],\n      \"type\": \"object\"\n    }\n  },\n  \"required\": [],\n  \"type\": \"object\"\n}",
