...
var VideoAgentCreate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		{
			Name:     "skip-agentic-stop",
			Type:     "bool",
			Default:  "false",
			Help:     "Set true to disable agentic stop (not recommended)",
			Required: false,
			Enum:     nil,
			Min:      nil,
			Max:      nil,
			Source:   "body",
			JSONName: "skip_agentic_stop",
		},
		{
			Name:     "style-id",
			Type:     "string",
...
var VideoAgentGet = &command.Spec{
	...
	Description:    "Get session status, progress, and chat messages. Use GET /v3/video-agents/{session_id}/resources/{resource_id} to fetch resource details.",
...
var VideoAgentResourcesGet = &command.Spec{
	Group:          "video-agent",
	Name:           "resources get",
	Summary:        "Get Video Agent session resource",
	Description:    "Get a single session resource by ID.",
...
var VideoAgentSend = &command.Spec{
	Group:          "video-agent",
	Name:           "send",
	Summary:        "Send message or request revision in Video Agent session",
	Description:    "Send a follow-up message, answer the agent's question, or request edits and revisions to a previously generated video.",
...
var VideoAgentVideosList = &command.Spec{
	Group:          "video-agent",
	Name:           "videos list",
	Summary:        "List Video Agent session videos",
	Description:    "List all videos generated in a Video Agent session, newest first. Each video has the same shape as GET /v3/videos/{video_id}.",
