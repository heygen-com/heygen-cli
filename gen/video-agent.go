...
var VideoAgentCreate = &command.Spec{
	...
	Flags: []command.FlagSpec{
		...
		},
		{
			...
			Type:     "string",
			Default:  "private",
			Help:     "Session visibility: private (owner only), team (workspace members), or public (anyone with the link). Defaults to private. Applies to the session and its conversation; does not change existing sessions.",
			Required: false,
